...
#         self.bbox_time_input.textChanged.connect(self.update_frame_preview_from_time)
...
#         video_path = self.input_path.text()
#         try:
#             time_sec = float(self.bbox_time_input.text())
#         except ValueError:
#             return
...
#         pixmap = QPixmap.fromImage(qimage).scaledToWidth(300, Qt.SmoothTransformation)
